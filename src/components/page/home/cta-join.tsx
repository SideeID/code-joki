...
export function CallToActionJoin() {
    const whatsappMessage = "Halo, saya tertarik dengan layanan joki coding Anda. Bisakah saya mendapatkan informasi lebih lanjut?";
        ...
        <div className='text-center'>
          ...
          >
            ...
            <Button
              ...
              size='lg'
            >
              <Link target='_blank' href={`https://wa.me/+6281949601347?text=${encodedBotMessage}`}>
          ...
          >
            Respon cepat dalam 30 menit • Dukungan 24/7 • Revisi tanpa batas
          </TextAnimate>
        </div>
      </section>
    );
